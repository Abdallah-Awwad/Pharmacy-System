            ...
            <div class="frame-box card-body p-3">
                <form action="" method="">
                    ...
                    <div class="form-group">
                        <button type="submit" class="add-btn btn btn-primary float-end" id="submitButton" onclick="editEmployee(); return false;">
                            <?= $lang["Submit"] ?>
                        </button>
                    </div>
                </form>
    ...
    <script> 
        ...
        $(document).ready(function() {
            requestAjax({'process' : 'readEmployee', 'employeeID' : (new URLSearchParams((new URL(window.location.href)).search)).get('edit')}, employeesControllerURL, function (result) {
