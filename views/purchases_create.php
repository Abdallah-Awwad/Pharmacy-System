            ...
            <form action="" method="">
                <div class="form-group mb-3 d-flex ">
                    ...
                    <div class="col-5 d-flex align-items-center justify-content-end">
                        <label class="col-3" for="id"><?= $lang["Expiration Date"];?></label>
                ...
                <div class="form-group mb-3 d-flex  ">
                    ...
                    <div class="col-2 d-flex justify-content-end">
                        <button type="button" onclick="addProduct();" class="add-btn btn btn-primary" id="addItem"><?= $lang["Add item"];?></button>
                    </div>
                </div>
