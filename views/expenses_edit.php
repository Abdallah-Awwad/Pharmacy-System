            ...
            <div class="frame-box card-body p-3">
                <form action="" method="">
                    ...
                    <div class="form-group">
                        <button type="submit" class="add-btn btn btn-primary float-end" id="submitButton" onclick="editExpense(); return false;"><?= $lang["Submit"];?></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script> 
        ...
        $(document).ready(function() {
            let bindValues = {
                'process': 'readExpense',
                'expenseID': (new URLSearchParams((new URL(window.location.href)).search)).get('edit')
            }
